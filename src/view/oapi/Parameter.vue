    ...
    <table class="table">
        <tbody>
            ...
            <tr v-if="!isHeader">
                ...
                <td>
                    <select v-model="sidebar.item.location" class="form-control wa">
            ...
            <tr>
                ...
                <td>
                    <Field :schema="sidebar.item.schema"></Field>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <span class="custom-control custom-switch">
                        <input
                            id="allowEmptyValue"
                            v-model="sidebar.item.allowEmptyValue"
                            type="checkbox"
            ...
            <tr>
                ...
                <td>
                    <span class="custom-control custom-switch">
                        <input
                            id="deprecated"
                            v-model="sidebar.item.deprecated"
                            type="checkbox"
                            class="custom-control-input"
                        />
...
import Field from '../schema/Field.vue'
...
export default defineComponent({
    ...
    setup(props, context) {
        return { locationxx: ['cookie', 'path', 'query'] }
    },
})
</script>
