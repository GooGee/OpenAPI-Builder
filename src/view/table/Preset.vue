<template>
    <table v-if="sidebar.item" class="table">
        ...
        <tbody>
            <tr v-for="item in sidebar.item.propertyManager.list" :key="item.id">
                <td>
                    <div class="btn-group mr11">
                        <DeleteButton
                            :manager="sidebar.item.propertyManager"
                            :item="item"
                        ></DeleteButton>
                        <ChangeButton
                            :manager="sidebar.item.propertyManager"
        ...
        <tfoot>
            <tr>
                <td>
                    <AddButton :manager="sidebar.item.propertyManager"></AddButton>
                </td>
                <td></td>
                <td></td>
            </tr>
